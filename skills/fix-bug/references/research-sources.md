...
[`skills/tdd/SKILL.md`](../../tdd/SKILL.md). For the layer decision (unit / component /
integration / E2E), see [`skills/e2e-testing/rules/layer-decision.md`](../../e2e-testing/rules/layer-decision.md).
