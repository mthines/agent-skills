...
[`screen-recorder`](../screen-recorder/SKILL.md) skill.
...
| Component is a hook or non-visual                         | Stop. Defer to [`tdd`](../tdd/SKILL.md).                                 |
...
- [`tdd`](../tdd/SKILL.md) — owns unit / hook tests.
  This skill defers below the visual surface to it.
- [`test-provenance-guard`](../test-provenance-guard/SKILL.md) —
...
- [`reviewer`](../../agents/reviewer.md) — runs the visual check pass
  ...
  visual diffs).
- [`screen-recorder`](../screen-recorder/SKILL.md) — captures short
