...
type: procedural
scope: <lesson-scope-name, e.g. aw-lessons | aw-tester-lessons | fix-bug-lessons | reviewer-lessons | implement-suggestion-lessons | ci-auto-fix-lessons | e2e-pr-stabilizer-lessons>
seen_count: 1
